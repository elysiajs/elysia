...
// handleFile's Headers-instance branch must apply the accept-ranges /
...
describe('handleFile defaults on Headers instance', () => {
...
// responseToSetHeaders strips content-encoding because it blocks chunked
...
describe('responseToSetHeaders strips content-encoding', () => {
...
//  (createRouteMap TDZ) retired 2026-07-03: src/adapter/bun/router.ts was
// dead code duplicating the fetch pipeline and has been deleted .

// a custom parse function exact-matches on the content-type. `main`
// truncated the header at the first `;`, but the rewrite passed the full
...
describe('contentType truncated at the first ;', () => {
