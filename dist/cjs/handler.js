...
exports.errorToResponse = exports.mapResponse = exports.mapEarlyResponse = void 0;
const jsonHeader = {
    headers: {
...
const mapEarlyResponse = (response, context) => {
        ...
        switch (typeof response) {
            ...
            case 'object':
                if (response instanceof Error)
                    return (0, exports.errorToResponse)(response, context.set.headers);
...
const mapResponse = (response, context) => {
    if (context.set.redirect)
        return Response.redirect(context.set.redirect, {
            headers: context.set.headers
        });
