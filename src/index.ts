...
export default class Elysia<Instance extends ElysiaInstance = ElysiaInstance> {
    ...
    // Comment out until I figure thing out
    // uses<T extends ((app: Elysia<any>) => MaybePromise<Elysia<any>>)[]>(a: T):
    //     { [K in keyof T]: ReturnType<T[K]> }[0] extends {
    //         meta: infer Meta
    //         schema: infer Schema
    //         store: infer Store
    //     }
